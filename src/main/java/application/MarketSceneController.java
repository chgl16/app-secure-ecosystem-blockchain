...
public class MarketSceneController {
	...
	public void OpenSettingScene(MouseEvent event) throws IOException {
		...
		Main.WhichUseSettingScene = "MarketScene.fxml";
	}
	...
	public void OpenAppMarket1Scene(MouseEvent event) throws IOException {
		...
		Main.WhichUseAppMarketScene = "MarketScene.fxml";
	...
	public void OpenApp1Scene(MouseEvent event) throws IOException {
		...
		Main.WhichUseAppScene = "MarketScene.fxml";
	}
	...
	// Event Listener on Button.onMouseClicked   // ���ش򿪹���
	@FXML
	public void OpenMarketManageScene(MouseEvent event) throws IOException {
