...
/**  �����������泡��  **/
public class DeveloperSceneController {
	@FXML
	...
	// Event Listener on Button.onMouseClicked
	@FXML
	public void OpenSettingScene(MouseEvent event) throws Exception {
		new ChangeSceneFunction("SettingScene.fxml");
		Main.WhichUseSettingScene = "DeveloperScene.fxml";
	}
	// Event Listener on Button.onMouseClicked
	@FXML
	public void ReturnLoginScene(MouseEvent event) throws Exception {
		Storage.m_num = 0;
	...
	public void OpenAppMarket1Scene(MouseEvent event) throws IOException {
		...
		Main.WhichUseAppMarketScene = "DeveloperScene.fxml";
	...
	public void OpenApp1Scene(MouseEvent event) throws IOException {
		...
		Main.WhichUseAppScene = "DeveloperScene.fxml";
	}
	...
	// Event Listener on Button.onMouseClicked   // ���ش�upload�ĳ���
	@FXML
	public void OpenDeveloperUploadScene(MouseEvent event) throws IOException {
		Storage.m_num = 0;
