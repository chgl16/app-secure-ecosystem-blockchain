...
public class UploadMarketSelectSceneController {
	@FXML
	...
	@FXML
	public void OpenUploadReadFileScene1(MouseEvent event) throws IOException {
		Storage.m[4] = m[1];
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene2(MouseEvent event) throws IOException {
		Storage.m[4] = m[2];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene3(MouseEvent event) throws IOException {
		Storage.m[4] = m[3];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene4(MouseEvent event) throws IOException {
		Storage.m[4] = m[4];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene5(MouseEvent event) throws IOException {
		Storage.m[4] = m[5];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene6(MouseEvent event) throws IOException {
		Storage.m[4] = m[6];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene7(MouseEvent event) throws IOException {
		Storage.m[4] = m[7];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene8(MouseEvent event) throws IOException {
		Storage.m[4] = m[8];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene9(MouseEvent event) throws IOException {
		Storage.m[4] = m[9];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene10(MouseEvent event) throws IOException {
		Storage.m[4] = m[10];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene11(MouseEvent event) throws IOException {
		Storage.m[4] = m[11];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	...
	// Event Listener on Label.onMouseClicked
	@FXML
	public void OpenUploadReadFileScene12(MouseEvent event) throws IOException {
		Storage.m[4] = m[12];
		new ChangeSceneFunction("UploadReadFileScene.fxml");
	}
	// Event Listener on Button.onMouseClicked
	@FXML
	public void ReturnDeveloperScene(MouseEvent event) throws IOException {
